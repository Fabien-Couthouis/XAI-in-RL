...
EXPOSED_OBSERVATIONS = {
    ...
    'left_team_tired_factor', 'left_team_yellow_card', 'left_team_number_passes', 'left_team_number_frames_holding_ball', 'left_team_number_goals', 'left_team_distance_to_goal', 'left_team_active',
    'left_team_roles', 'right_team', 'right_team_direction',
    'right_team_tired_factor', 'right_team_yellow_card', 'right_team_number_passes', 'right_team_number_frames_holding_ball', 'right_team_number_goals', 'right_team_distance_to_goal', 'right_team_active',
